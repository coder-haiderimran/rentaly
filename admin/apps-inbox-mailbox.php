...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/apps-inbox-mailbox.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:35:32 GMT -->
<head>
	<meta charset="UTF-8">
			...
			<div class="sidebar-menu custom-scroll pt-4">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							<li class="active"><a href="apps-inbox-mailbox.php"><span>Mailbox</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						...
						<div class="col-md-6 text-start text-md-end">
							<!-- Add Button Start-->
							<a href="apps-inbox-compose.php" class="btn btn-primary">Compose</a>
							<!-- Add Button End-->
						</div>
					</div>
					<!-- Page Top End -->
					...
					<div class="row">
						...
						<div class="col-xxl-3 mb6">
							<div class="card shadow-card p6">
								<a href="apps-inbox-compose.php" class="btn btn-primary mb6">Compose</a>
										...
										<table class="table qd-table mb6 align-middle">
											<tbody>
												<tr>
													...
													<td>
														<a href="apps-inbox-view-reply.php" class="text-decoration-none d-block">
...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/apps-inbox-mailbox.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:35:33 GMT -->
</html>