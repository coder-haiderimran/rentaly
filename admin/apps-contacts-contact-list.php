...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/apps-contacts-contact-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:35:33 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						...
						<div class="col-md-6 text-start text-md-end">
							...
							<a href="apps-contacts-add-contact.php" class="btn btn-primary">Add New</a>
							<!-- Add Button End-->
						</div>
					</div>
					<!-- Page Top End -->
										...
										<table class="table qd-table mb6 align-middle">
											<tbody>
												<tr>
													...
													<td>
														<a href="apps-contacts-view-contact.php" class="text-decoration-none d-block">
													...
													<td>
														<a href="apps-contacts-view-contact.php" class="text-decoration-none text-body hover-primary">norman@example.com</a>
													</td>
													<td class="text-end">
												...
												<tr>
													...
													<td>
														<a href="apps-contacts-view-contact.php" class="text-decoration-none text-body hover-primary">fleece@example.com</a>
													</td>
													<td class="text-end">
														<div class="d-flex flex-row align-items-center justify-content-end">
															<button class="btn btn-success btn-soft me2">
												...
												<tr>
													...
													<td>
														<a href="apps-contacts-view-contact.php" class="text-decoration-none text-body hover-primary">thomas@domain.com</a>
													</td>
													<td class="text-end">
														<div class="d-flex flex-row align-items-center justify-content-end">
															<button class="btn btn-success btn-soft me2">
												...
												<tr>
													...
													<td>
														<a href="apps-contacts-view-contact.php" class="text-decoration-none text-body hover-primary">benjamin@example.com</a>
													</td>
													<td class="text-end">
														<div class="d-flex flex-row align-items-center justify-content-end">
															<button class="btn btn-success btn-soft me2">
												...
												<tr>
													...
													<td>
														<a href="apps-contacts-view-contact.php" class="text-decoration-none text-body hover-primary">niles@site.com</a>
													</td>
													<td class="text-end">
														<div class="d-flex flex-row align-items-center justify-content-end">
															<button class="btn btn-success btn-soft me2">
												...
												<tr>
													...
													<td>
														<a href="apps-contacts-view-contact.php" class="text-decoration-none text-body hover-primary">rodney@example.com</a>
													</td>
													<td class="text-end">
														<div class="d-flex flex-row align-items-center justify-content-end">
															<button class="btn btn-success btn-soft me2">
												...
												<tr>
													...
													<td>
														<a href="apps-contacts-view-contact.php" class="text-decoration-none text-body hover-primary">wisteria@revenclaw.com</a>
													</td>
													<td class="text-end">
														<div class="d-flex flex-row align-items-center justify-content-end">
															<button class="btn btn-success btn-soft me2">
												...
												<tr>
													...
													<td>
														<a href="apps-contacts-view-contact.php" class="text-decoration-none text-body hover-primary">justin@yoursite.com</a>
													</td>
													<td class="text-end">
														<div class="d-flex flex-row align-items-center justify-content-end">
															<button class="btn btn-success btn-soft me2">
												...
												<tr>
													...
													<td>
														<a href="apps-contacts-view-contact.php" class="text-decoration-none text-body hover-primary">nathaneal@sitename.com</a>
													</td>
													<td class="text-end">
														<div class="d-flex flex-row align-items-center justify-content-end">
															<button class="btn btn-success btn-soft me2">
												...
												<tr>
													...
													<td>
														<a href="apps-contacts-view-contact.php" class="text-decoration-none text-body hover-primary">indigo@example.com</a>
													</td>
													<td class="text-end">
														<div class="d-flex flex-row align-items-center justify-content-end">
															<button class="btn btn-success btn-soft me2">
...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/apps-contacts-contact-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:35:34 GMT -->
</html>