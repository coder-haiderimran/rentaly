...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/projects-blog-blog-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:33:36 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="projects-blog-blog-list.php"><span>Blog List</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						...
						<div class="col-md-6 text-start text-md-end">
							...
							<!-- Add Button Start-->
							<a href="projects-blog-add-blog.php" class="btn btn-primary">Add Post</a>
							<!-- Add Button End-->
						</div>
					</div>
					<!-- Page Top End -->
...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/projects-blog-blog-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:35:21 GMT -->
</html>