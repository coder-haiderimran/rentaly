...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/apps-file-manager-files.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:36:28 GMT -->
<head>
	<meta charset="UTF-8">
			...
			<div class="sidebar-menu custom-scroll pt-4">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							<li class="active"><a href="apps-file-manager-files.php"><span>Files</span></a></li>
						...
						<div class="col-xxl-9 mb6">
							...
							<div class="card shadow-card mb6">
								...
								<ul class="horizontal-menu ss-container">
									<li class="active"><a href="apps-file-manager-files.php">Files</a></li>
									<li><a href="apps-file-manager-setting.php">Settings</a></li>
								</ul>
							</div>
							<!-- Nav End -->
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<a href="#" class="d-flex align-items-center justify-content-start text-decoration-none">
															...
															<strong class="text-heading">about-us.php</strong>
														</a>
													</td>
													<td>
														<span>1.2 MB</span>
												...
												<tr>
													...
													<td>
														<a href="#" class="d-flex align-items-center justify-content-start text-decoration-none">
															<img src="assets/media/icons/html.svg" alt="" class="me4">
															<strong class="text-heading">contact.php</strong>
														</a>
													</td>
													<td>
														<span>0.8 MB</span>
												...
												<tr>
													...
													<td>
														<a href="#" class="d-flex align-items-center justify-content-start text-decoration-none">
															<img src="assets/media/icons/html.svg" alt="" class="me4">
															<strong class="text-heading">index.php</strong>
														</a>
													</td>
													<td>
														<span>1.4 MB</span>
...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/apps-file-manager-files.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:36:30 GMT -->
</html>