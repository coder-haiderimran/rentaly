...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/apps-tasks-files.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:36:14 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-tasks-files.php"><span>Files</span></a></li>
						</ul>
					</li>
						...
						<div class="col-12 mb6">
							<div class="card shadow-card">
								...
								<ul class="horizontal-menu ss-container">
									<li><a href="apps-tasks-task-detail.php">Overview</a></li>
									<li><a href="apps-tasks-users.php">Users</a></li>
									<li class="active"><a href="apps-tasks-files.php">Files</a></li>
								</ul>
							</div>
						</div>
						<!-- Task Top Start -->
