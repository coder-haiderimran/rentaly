...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/pages-account-user-documents.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:36:36 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="pages-account-user-documents.php"><span>Documents</span></a></li>
						...
						<div class="col-12">
							...
							<div class="card shadow-card overflow-hidden">
								...
								<ul class="horizontal-menu ss-container">
									...
									<li class="active"><a href="pages-account-user-documents.php">Documents</a></li>
							...
							<div class="alert alert-primary mb0" role="alert">
								<div class="row align-items-center">
									...
									<div class="col-lg-5 text-end">
										<a href="apps-file-manager-files.php" class="btn btn-primary">File Manager</a>
									</div>
								</div>
							</div>
						</div>
