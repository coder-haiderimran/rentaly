...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/pages-account-user-project.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:36:36 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="pages-account-user-project.php"><span>Project</span></a></li>
				...
				<div class="container p0">
						...
						<div class="col-12">
							...
							<div class="card shadow-card overflow-hidden">
								...
								<ul class="horizontal-menu ss-container">
									<li><a href="pages-account-user-overview.php">Overview</a></li>
									<li><a href="pages-account-user-settings.php">Settings</a></li>
									<li><a href="pages-account-user-security.php">Security</a></li>
									<li><a href="pages-account-user-activity.php">Activity</a></li>
									<li><a href="pages-account-user-billing.php">Billing</a></li>
									<li><a href="pages-account-user-statements.php">Statements</a></li>
									<li><a href="pages-account-user-referrals.php">Referrals</a></li>
									<li class="active"><a href="pages-account-user-project.php">Project</a></li>
									<li><a href="pages-account-user-documents.php">Documents</a></li>
									<li><a href="pages-account-user-followers.php">Followers</a></li>
									<li><a href="pages-account-user-api-keys.php">API Keys</a></li>
									<li><a href="pages-account-user-logs.php">Logs</a></li>
								</ul>
							</div>
							<!-- Nav End -->
						</div>
					...
					<div class="row">
						...
						<div class="col-xxl-4 mb6">
							<a href="apps-projects-project-overview.php" class="card shadow-card text-decoration-none overflow-hidden">
					...
					<div class="row">
						<!-- Card 1 Start -->
						<div class="col-xxl-4 mb6">
							<a href="apps-projects-project-overview.php" class="card shadow-card p6 text-decoration-none">
								<div class="d-flex flex-row justify-content-between align-items-center mb4">
									<span class="badge rounded-pill badge-soft text-bg-primary">Web Design</span>
									<div class="dropdown">
										<button type="button" class="border-0 bg-transparent p0 outline-none dropdown-toggle arrow-none" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
