...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/apps-file-manager-setting.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:36:31 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-file-manager-setting.php"><span>Settings</span></a></li>
						</ul>
					</li>
				</ul>
				<!-- ***** Apps Menu End ***** -->
						...
						<div class="col-xxl-9 mb6">
							...
							<div class="card shadow-card mb6">
								...
								<ul class="horizontal-menu ss-container">
									<li><a href="apps-file-manager-files.php">Files</a></li>
									<li class="active"><a href="apps-file-manager-setting.php">Settings</a></li>
								</ul>
							</div>
							<!-- Nav End -->
