...
<html lang="en" data-bs-theme="light">
  <!-- Mirrored from qoduby.tempload.com/html/demo1/dist/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:30:42 GMT -->
  <head>
    <meta charset="UTF-8" />
    ...
    <meta
      name="description"
      content="Qoduby - Admin & Dashboard template by tempload."
    />
    <meta
      name="keywords"
  ...
  <body>
    <div class="app-root d-flex flex-column">
      ...
      <div class="app-sidebar">
        ...
        <div class="sidebar-logo d-flex justify-content-center">
          <a href="index.php">
            <img
              src="assets/media/logo/logo-default.svg"
              height="30"
              alt="Qoduby"
            />
          </a>
        ...
        <div class="sidebar-menu custom-scroll pt-4">
          ...
          <ul class="menu-group m-0 px-4 mb-4">
            <li class="sub-menu active">
              ...
              <ul class="sub-menu-group">
                <li class="active">
                  <a href="index.php"><span>Default</span></a>
                </li>
                <li>
                  <a href="dashboards-ecommerce.php"><span>eCommerce</span></a>
                </li>
                <li>
                  <a href="dashboards-projects.php"><span>Projects</span></a>
                </li>
                <li>
                  <a href="dashboards-website-analytics.php"
                    ><span>Website Analytics</span></a
                  >
                </li>
                <li>
                  <a href="dashboards-crypto.php"><span>Crypto</span></a>
                </li>
                <li>
                  <a href="dashboards-car-rental.php"
          ...
          <ul class="menu-group m-0 px-4 mb-4">
            <li class="sub-menu">
              ...
              <ul class="sub-menu-group">
                ...
                <li>
                  <a href="projects-car-rental-reservation-details.php"
            ...
            <li class="sub-menu">
              ...
              <ul class="sub-menu-group">
                <li>
                  <a href="projects-ecommerce-categories.php"
                    ><span>Categories</span></a
                  >
                </li>
                <li>
                  <a href="projects-ecommerce-add-category.php"
                    ><span>Add Category</span></a
                  >
                </li>
                <li>
                  <a href="projects-ecommerce-products.php"
                    ><span>Products</span></a
                  >
                </li>
                <li>
                  <a href="projects-ecommerce-add-product.php"
                    ><span>Add Product</span></a
                  >
                </li>
                <li>
                  <a href="projects-ecommerce-order-list.php"
                    ><span>Order List</span></a
                  >
                </li>
                <li>
                  <a href="projects-ecommerce-order-details.php"
            ...
            <li class="sub-menu">
              ...
              <ul class="sub-menu-group">
                <li>
                  <a href="projects-blog-categories.php"
                    ><span>Categories</span></a
                  >
                </li>
                <li>
                  <a href="projects-blog-blog-list.php"
                    ><span>Blog List</span></a
                  >
                </li>
                <li>
                  <a href="projects-blog-add-blog.php"
                    ><span>Add Blog</span></a
                  >
                </li>
                <li>
                  <a href="projects-blog-comments.php"
            ...
            <li class="sub-menu">
              ...
              <ul class="sub-menu-group">
                <li>
                  <a href="projects-api-key-manager-api-list.php"
                    ><span>API List</span></a
                  >
                </li>
                <li>
                  <a href="projects-api-key-manager-languages.php"
                    ><span>Languages</span></a
                  >
                </li>
                <li>
                  <a href="projects-api-key-manager-language-details.php"
                    ><span>Language Details</span></a
                  >
                </li>
              </ul>
            </li>
          ...
          <ul class="menu-group m-0 px-4 mb-4">
            <li class="sub-menu">
              ...
              <ul class="sub-menu-group">
                <li>
                  <a href="apps-calendar-calendar-1.php"
                    ><span>Calendar 1</span></a
                  >
                </li>
                <li>
                  <a href="apps-calendar-calendar-2.php"
                    ><span>Calendar 2</span></a
                  >
                </li>
              </ul>
            </li>
            <li class="sub-menu">
              ...
              <ul class="sub-menu-group">
                <li>
                  <a href="apps-chat-single-chat.php"
                    ><span>Single Chat</span></a
                  >
                </li>
                <li>
                  <a href="apps-chat-group-chat.php"
            ...
            <li class="sub-menu">
              ...
              <ul class="sub-menu-group">
                <li>
                  <a href="apps-inbox-mailbox.php"><span>Mailbox</span></a>
                </li>
                <li>
                  <a href="apps-inbox-compose.php"><span>Compose</span></a>
                </li>
                <li>
                  <a href="apps-inbox-view-reply.php"
                    ><span>View & Reply</span></a
                  >
                </li>
              </ul>
            </li>
            <li class="sub-menu">
              ...
              <ul class="sub-menu-group">
                <li>
                  <a href="apps-contacts-contact-list.php"
                    ><span>Contact List</span></a
                  >
                </li>
                <li>
                  <a href="apps-contacts-add-contact.php"
                    ><span>Add Contact</span></a
                  >
                </li>
                <li>
                  <a href="apps-contacts-view-contact.php"
            ...
            <li class="sub-menu">
              ...
              <ul class="sub-menu-group">
                <li>
                  <a href="apps-projects-project-list.php"
                    ><span>Project List</span></a
                  >
                </li>
                <li>
                  <a href="apps-projects-add-project.php"
                    ><span>Add Project</span></a
                  >
                </li>
                <li>
                  <a href="apps-projects-project-overview.php"
                    ><span>Project Overview</span></a
                  >
                </li>
                <li>
                  <a href="apps-projects-users.php"><span>Users</span></a>
                </li>
                <li>
                  <a href="apps-projects-files.php"><span>Files</span></a>
                </li>
                <li>
                  <a href="apps-projects-activity.php"
                    ><span>Activity</span></a
                  >
                </li>
                <li>
                  <a href="apps-projects-settings.php"
            ...
            <li class="sub-menu">
              ...
              <ul class="sub-menu-group">
                <li>
                  <a href="apps-tasks-overview.php"><span>Overview</span></a>
                </li>
                <li>
                  <a href="apps-tasks-add-task.php"><span>Add Task</span></a>
                </li>
                <li>
                  <a href="apps-tasks-task-detail.php"
                    ><span>Task Detail</span></a
                  >
                </li>
                <li>
                  <a href="apps-tasks-users.php"><span>Users</span></a>
                </li>
                <li>
                  <a href="apps-tasks-files.php"><span>Files</span></a>
                </li>
              </ul>
            </li>
            <li class="single-menu">
              <a
                href="apps-kanban-kanban-board.php"
                class="d-flex align-items-center justify-content-between"
              >
                <div class="d-flex align-items-center">
                  <i
            ...
            <li class="sub-menu">
              ...
              <ul class="sub-menu-group">
                <li>
                  <a href="apps-crm-contact.php"><span>Contact</span></a>
                </li>
                <li>
                  <a href="apps-crm-company.php"><span>Company</span></a>
                </li>
                <li>
                  <a href="apps-crm-deals.php"><span>Deals</span></a>
                </li>
              </ul>
            </li>
            <li class="sub-menu">
              ...
              <ul class="sub-menu-group">
                <li>
                  <a href="apps-invoice-manager-invoice-list.php"
                    ><span>Invoice List</span></a
                  >
                </li>
                <li>
                  <a href="apps-invoice-manager-new-invoice.php"
                    ><span>New Invoice</span></a
                  >
                </li>
                <li>
                  <a href="apps-invoice-manager-invoice-details.php"
            ...
            <li class="sub-menu">
              ...
              <ul class="sub-menu-group">
                <li>
                  <a href="apps-support-center-overview.php"
                    ><span>Overview</span></a
                  >
                </li>
                <li>
                  <a href="apps-support-center-ticket-details.php"
            ...
            <li class="sub-menu">
              ...
              <ul class="sub-menu-group">
                <li>
                  <a href="apps-file-manager-files.php"><span>Files</span></a>
                </li>
                <li>
                  <a href="apps-file-manager-blank-directory.php"
                    ><span>Blank Directory</span></a
                  >
                </li>
                <li>
                  <a href="apps-file-manager-setting.php"
                    ><span>Settings</span></a
                  >
                </li>
              </ul>
          ...
          <ul class="menu-group m-0 px-4 mb-4">
            <li class="sub-menu">
              ...
              <ul class="sub-menu-group">
                <li>
                  <a href="pages-account-user-overview.php"
                    ><span>Overview</span></a
                  >
                </li>
                <li>
                  <a href="pages-account-user-settings.php"
                    ><span>Settings</span></a
                  >
                </li>
                <li>
                  <a href="pages-account-user-security.php"
                    ><span>Security</span></a
                  >
                </li>
                <li>
                  <a href="pages-account-user-activity.php"
                    ><span>Activity</span></a
                  >
                </li>
                <li>
                  <a href="pages-account-user-billing.php"
                    ><span>Billing</span></a
                  >
                </li>
                <li>
                  <a href="pages-account-user-statements.php"
                    ><span>Statements</span></a
                  >
                </li>
                <li>
                  <a href="pages-account-user-referrals.php"
                    ><span>Referrals</span></a
                  >
                </li>
                <li>
                  <a href="pages-account-user-project.php"
                    ><span>Project</span></a
                  >
                </li>
                <li>
                  <a href="pages-account-user-documents.php"
                    ><span>Documents</span></a
                  >
                </li>
                <li>
                  <a href="pages-account-user-followers.php"
                    ><span>Followers</span></a
                  >
                </li>
                <li>
                  <a href="pages-account-user-api-keys.php"
                    ><span>API Keys</span></a
                  >
                </li>
                <li>
                  <a href="pages-account-user-logs.php"><span>Logs</span></a>
                </li>
              </ul>
            </li>
            <li class="sub-menu">
              ...
              <ul class="sub-menu-group">
                <li>
                  <a href="pages-authentication-sign-in.php"
                    ><span>Sign-in</span></a
                  >
                </li>
                <li>
                  <a href="pages-authentication-sign-up.php"
                    ><span>Sign-up</span></a
                  >
                </li>
                <li>
                  <a href="pages-authentication-reset-password.php"
                    ><span>Reset Password</span></a
                  >
                </li>
                <li>
                  <a href="pages-authentication-new-password.php"
                    ><span>New Password</span></a
                  >
                </li>
              </ul>
            </li>
          ...
          <ul class="menu-group m-0 px-4 pb-1 mb-3">
            <li class="single-menu">
              <a
                target="_blank"
                href="../../../documentation/components.php"
                class="d-flex align-items-center justify-content-between"
              >
                <div class="d-flex align-items-center">
                  <i
            ...
            <li class="single-menu">
              <a
                target="_blank"
                href="../../../documentation/changelog.php"
                class="d-flex align-items-center justify-content-between"
              >
                <div class="d-flex align-items-center">
                  <i
        ...
        <div
          class="sidebar-footer d-flex align-items-center justify-content-center"
        >
          <a
            href="../../../documentation/index.php"
                      ...
                      <div class="row g-0 align-items-center">
                        ...
                        <div class="col-lg-5">
                          <div class="menu-content ps6 sm-p-0">
                            <strong class="text-heading d-block mb-2"
                              >DASHBOARDS</strong
                            >
                            <ul class="mega-sub-menu">
                              <li>
                                <a class="hover-primary" href="index.php"
                                  >Default</a
                                >
                              </li>
                              <li>
                              ...
                              <li>
                                <a
                                  class="hover-primary"
                                  href="dashboards-car-rental.php"
                                  >Car Rental</a
                                >
                              </li>
                            </ul>
                        ...
                        <div class="col-lg-12">
                          <div class="menu-content">
                            <div class="row">
                              <div class="col-sm-3 mb-sm-1">
                                ...
                                <ul class="mega-sub-menu">
                                  <li>
                                    <a
                                      class="hover-primary"
                                      href="projects-ecommerce-categories.php"
                                      >Categories</a
                                    >
                                  </li>
                                  <li>
                                    <a
                                      class="hover-primary"
                                      href="projects-ecommerce-add-category.php"
                                      >Add Category</a
                                    >
                                  </li>
                                  <li>
                                    <a
                                      class="hover-primary"
                                      href="projects-ecommerce-products.php"
                                      >Products</a
                                    >
                                  </li>
                                  <li>
                                    <a
                                      class="hover-primary"
                                      href="projects-ecommerce-add-product.php"
                                      >Add Product</a
                                    >
                                  </li>
                                  <li>
                                    <a
                                      class="hover-primary"
                                      href="projects-ecommerce-order-list.php"
                                      >Order List</a
                                    >
                                  </li>
                                  <li>
                                    <a
                                      class="hover-primary"
                                      href="projects-ecommerce-order-details.php"
                                      >Order Details</a
                                    >
                                  </li>
                                </ul>
                              ...
                              <div class="col-sm-3 mb-sm-1">
                                ...
                                <ul class="mega-sub-menu">
                                  <li>
                                    <a
                                      class="hover-primary"
                                      href="projects-blog-categories.php"
                                      >Categories</a
                                    >
                                  </li>
                                  <li>
                                    <a
                                      class="hover-primary"
                                      href="projects-blog-blog-list.php"
                                      >Blog List</a
                                    >
                                  </li>
                                  <li>
                                    <a
                                      class="hover-primary"
                                      href="projects-blog-add-blog.php"
                                      >Add Blog</a
                                    >
                                  </li>
                                  <li>
                                    <a
                                      class="hover-primary"
                                      href="projects-blog-comments.php"
                                      >Comments</a
                                    >
                                  </li>
                                </ul>
                              ...
                              <div class="col-sm-3 mb-sm-1">
                                ...
                                <ul class="mega-sub-menu">
                                  <li>
                                    <a
                                      class="hover-primary"
                                      href="projects-car-rental-car-list.php"
                                      >Car List</a
                                    >
                                  </li>
                                  <li>
                                    <a
                                      class="hover-primary"
                                      href="projects-car-rental-car-details.php"
                                      >Car Details</a
                                    >
                                  </li>
                                  <li>
                                    <a
                                      class="hover-primary"
                                      href="projects-car-rental-reservations.php"
                                      >Reservations</a
                                    >
                                  </li>
                                  <li>
                                    <a
                                      class="hover-primary"
                                      href="projects-car-rental-reservation-details.php"
                              ...
                              <div class="col-sm-3">
                                <strong class="text-heading d-block mb-2"
                                  >API KEY MANAGER</strong
                                >
                                <ul class="mega-sub-menu">
                                  <li>
                                    <a
                                      class="hover-primary"
                                      href="projects-api-key-manager-api-list.php"
                                      >API List</a
                                    >
                                  </li>
                                  <li>
                                    <a
                                      class="hover-primary"
                                      href="projects-api-key-manager-languages.php"
                                      >Languages</a
                                    >
                                  </li>
                                  <li>
                                    <a
                                      class="hover-primary"
                                      href="projects-api-key-manager-language-details.php"
                                      >Language Details</a
                                    >
                                  </li>
                                </ul>
                      ...
                      <div class="top-level-menu-wrapper">
                        <ul class="top-sub-menu-group">
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="apps-calendar-calendar-1.php"
                              ><span>Calendar 1</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="apps-calendar-calendar-2.php"
                              ><span>Calendar 2</span></a
                            >
                          </li>
                        </ul>
                      ...
                      <div class="top-level-menu-wrapper">
                        <ul class="top-sub-menu-group">
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="apps-chat-single-chat.php"
                              ><span>Single Chat</span></a
                            >
                          </li>
                          <li>
                      ...
                      <div class="top-level-menu-wrapper">
                        <ul class="top-sub-menu-group">
                          ...
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="apps-inbox-view-reply.php"
                              ><span>View & Reply</span></a
                            >
                          </li>
                        </ul>
                      ...
                      <div class="top-level-menu-wrapper">
                        <ul class="top-sub-menu-group">
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="apps-contacts-contact-list.php"
                              ><span>Contact List</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="apps-contacts-add-contact.php"
                              ><span>Add Contact</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="apps-contacts-view-contact.php"
                              ><span>View Contact</span></a
                            >
                          </li>
                        </ul>
                      ...
                      <div class="top-level-menu-wrapper">
                        <ul class="top-sub-menu-group">
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="apps-projects-project-list.php"
                              ><span>Project List</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="apps-projects-add-project.php"
                              ><span>Add Project</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="apps-projects-project-overview.php"
                              ><span>Project Overview</span></a
                            >
                          </li>
                          <li>
                          ...
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="apps-projects-activity.php"
                              ><span>Activity</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="apps-projects-settings.php"
                              ><span>Settings</span></a
                            >
                          </li>
                        </ul>
                      ...
                      <div class="top-level-menu-wrapper">
                        <ul class="top-sub-menu-group">
                          ...
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="apps-tasks-task-detail.php"
                              ><span>Task Detail</span></a
                            >
                          </li>
                          <li>
                      ...
                      <div class="top-level-menu-wrapper">
                        <ul class="top-sub-menu-group">
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="apps-invoice-manager-invoice-list.php"
                              ><span>Invoice List</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="apps-invoice-manager-new-invoice.php"
                              ><span>New Invoice</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="apps-invoice-manager-invoice-details.php"
                              ><span>Invoice Details</span></a
                            >
                          </li>
                        </ul>
                      ...
                      <div class="top-level-menu-wrapper">
                        <ul class="top-sub-menu-group">
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="apps-support-center-overview.php"
                              ><span>Overview</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="apps-support-center-ticket-details.php"
                              ><span>Ticket Details</span></a
                            >
                          </li>
                        </ul>
                      ...
                      <div class="top-level-menu-wrapper">
                        <ul class="top-sub-menu-group">
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="apps-file-manager-files.php"
                              ><span>Files</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="apps-file-manager-blank-directory.php"
                              ><span>Blank Directory</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="apps-file-manager-setting.php"
                              ><span>Settings</span></a
                            >
                          </li>
                        </ul>
                      ...
                      <div class="top-level-menu-wrapper">
                        <ul class="top-sub-menu-group">
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="pages-account-user-overview.php"
                              ><span>Overview</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="pages-account-user-settings.php"
                              ><span>Settings</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="pages-account-user-security.php"
                              ><span>Security</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="pages-account-user-activity.php"
                              ><span>Activity</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="pages-account-user-billing.php"
                              ><span>Billing</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="pages-account-user-statements.php"
                              ><span>Statements</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="pages-account-user-referrals.php"
                              ><span>Referrals</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="pages-account-user-project.php"
                              ><span>Project</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="pages-account-user-documents.php"
                              ><span>Documents</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="pages-account-user-followers.php"
                              ><span>Followers</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="pages-account-user-api-keys.php"
                              ><span>API Keys</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="pages-account-user-logs.php"
                              ><span>Logs</span></a
                            >
                          </li>
                        </ul>
                      ...
                      <div class="top-level-menu-wrapper">
                        <ul class="top-sub-menu-group">
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="pages-authentication-sign-in.php"
                              ><span>Sign-in</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="pages-authentication-sign-up.php"
                              ><span>Sign-up</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="pages-authentication-reset-password.php"
                              ><span>Reset Password</span></a
                            >
                          </li>
                          <li>
                            <a
                              class="d-flex align-items-center justify-content-between"
                              href="pages-authentication-new-password.php"
                              ><span>New Password</span></a
                            >
                          </li>
                        </ul>
          ...
          <div class="header-tools d-flex align-items-center">
            ...
            <div class="dropdown me3">
              ...
              <div class="dropdown-menu width-350 p0">
                ...
                <div class="p3">
                  ...
                  >
                    <i
                      ...
                      stroke-width="2"
                      height="22"
                      class="text-body-tertiary position-absolute"
                    ></i>
                    <input
                      type="text"
                ...
                <div
                  class="height-350 overflow-hidden search-scroll ss-container"
                >
                  <div class="p5">
                    <a
                      href="#"
            ...
            <div class="dropdown me3">
              ...
              >
                ...
                ></i>
                <span
                  class="badge rounded-pill text-bg-danger position-absolute scale-70 top-0 end-0"
                  >3</span
                >
              </a>
              <!-- ***** Icon End ***** -->
              ...
              <!-- ***** Chat Content Start ***** -->
              <div
                class="offcanvas offcanvas-end offcanvas-chat"
                tabindex="-1"
                id="offcanvasRight"
              ...
              >
                <div class="offcanvas-header p6">
                  <div class="d-flex">
                    <div class="d-flex align-items-center">
                      <div class="position-relative">
                        <div
                          class="img-fix rounded-circle me3 height-40 width-40"
                        >
                          <img src="assets/media/avatars/12.jpg" alt="" />
                        </div>
                        <span
                          class="badge rounded-pill text-bg-success position-absolute scale-70 bottom-0 end-0"
                          >&nbsp;</span
                        >
                      </div>
                  ...
                  <div class="d-flex">
                        ...
                        <li>
                          ...
                          >
                            ...
                            <i
                              ...
                              data-bs-title="If you delete it, this action cannot be undone."
                            ></i>
                          </a>
                        </li>
                      </ul>
                    ...
                    <button
                      type="button"
                      class="border-0 bg-transparent p0 outline-none"
                ...
                <div class="offcanvas-body p0 overflow-hidden">
                  <div
                    class="p6 pt3 pb3 chat-scroll ss-container"
                    style="height: 100%"
                  >
                    <div class="d-flex flex-column align-items-start mb6">
                      <div class="d-flex align-items-center mb3">
                        <div
                          class="img-fix rounded-circle me3 height-30 width-30 me3"
                        >
                          <img src="assets/media/avatars/12.jpg" alt="" />
                        </div>
                      ...
                      <div class="p4 bg-info-subtle rounded">
                        <span class="text-heading"
                          >Hi, can you send me the files of the new project by
                          email?</span
                        >
                      </div>
                    </div>
                    ...
                    <div class="d-flex flex-column align-items-end mb6">
                      <div class="d-flex align-items-center mb3">
                        ...
                        <div
                          class="img-fix rounded-circle me3 height-30 width-30 ms3"
                        >
                      ...
                      <div class="p4 bg-light rounded">
                        <span class="text-heading"
                          >I don't have all the files. I can only send
                          documents.</span
                        >
                      </div>
                    </div>
                    ...
                    <div class="d-flex flex-column align-items-end mb6">
                      ...
                      <div class="p4 bg-light rounded">
                        <span class="text-heading"
                          >This file contains all the information.</span
                        >
                      </div>
                    </div>
                    ...
                    <div class="d-flex flex-column align-items-start">
                      ...
                      <div class="p4 bg-info-subtle rounded">
                        <span class="text-heading"
                          >Thank you very much. I owe you lunch 😁</span
                        >
                      </div>
                    </div>
                  </div>
            ...
            <div class="dropdown me3">
              ...
              <div class="dropdown-menu width-350 p0">
                <!-- ***** Content Start ***** -->
                <div
                  class="d-flex justify-content-between align-items-center p5"
                >
                  <h6 class="mb0">My Apps</h6>
                  <span class="badge rounded-pill badge-soft text-bg-info"
                    >7 Updates</span
                  >
                </div>
                <hr class="opacity-20 m0" />
                <div class="p5">
                  <div class="container-fluid p0">
                    <div class="row">
                      ...
                      <div class="col-4 mb5">
                        ...
                        >
                          <img
                            class="mb-2"
                            src="assets/media/logos/bitbucket.svg"
                            height="30"
                            alt=""
                          />
                      ...
                      <div class="col-4 mb5">
                        ...
                        >
                          <img
                            class="mb-2"
                            src="assets/media/logos/dribbble.svg"
                            height="30"
                            alt=""
                          />
                      ...
                      <div class="col-4 mb5">
                        ...
                        >
                          <img
                            class="mb-2"
                            src="assets/media/logos/dropbox.svg"
                            height="30"
                            alt=""
                          />
                      ...
                      <div class="col-4 mb5">
                        ...
                        >
                          <img
                            class="mb-2"
                            src="assets/media/logos/mailchimp.svg"
                            height="30"
                            alt=""
                          />
                      ...
                      <div class="col-4 mb5">
                        ...
                        >
                          <img
                            class="mb-2"
                            src="assets/media/logos/slack.svg"
                            height="30"
                            alt=""
                          />
                      ...
                      <div class="col-4 mb5">
                        ...
                        >
                          <img
                            class="mb-2"
                            src="assets/media/logos/amazon.svg"
                            height="30"
                            alt=""
                          />
                      ...
                      <div class="col-4 mb5">
                        ...
                        >
                          <img
                            class="mb-2"
                            src="assets/media/logos/gitlab.svg"
                            height="30"
                            alt=""
                          />
                      ...
                      <div class="col-4 mb5">
                        ...
                        >
                          <img
                            class="mb-2"
                            src="assets/media/logos/figma.svg"
                            height="30"
                            alt=""
                          />
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <a
                          class="btn btn-primary btn-soft btn-sm d-block"
                          href="#"
                          role="button"
                          >View App Market</a
                        >
            ...
            <div class="dropdown me3">
              ...
              >
                ...
                ></i>
                <span
                  class="badge rounded-pill text-bg-info position-absolute scale-70 top-0 end-0"
                  >2</span
                >
              </a>
              <!-- ***** Icon End ***** -->
              ...
              <div class="dropdown-menu width-350 p0">
                ...
                <div class="p5">
                  ...
                  >
                    ...
                    <div class="d-flex flex-column align-items-start">
                      <strong class="text-heading me1"
                        >Congratulations Barry! 🥳</strong
                      >
                      <span class="mb1 text-body"
                        >You've been the top seller this month.</span
                      >
                      <span class="badge rounded-pill badge-soft text-bg-info"
                        >16 minutes ago</span
                      >
                  ...
                  >
                    ...
                    <div class="d-flex flex-column align-items-start">
                      <strong class="text-heading me1"
                        >Qoduby has been sold 🤑</strong
                      >
                      <span class="mb1 text-body"
                        >You earned $40 from this sale.</span
                      >
                      <span
                        class="badge rounded-pill badge-soft text-bg-primary"
                        >22 minutes ago</span
                      >
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div class="d-flex flex-column align-items-start">
                      ...
                      >
                      <span class="mb1 text-body"
                        >The monthly report was uploaded.</span
                      >
                      <span
                        class="badge rounded-pill badge-soft text-bg-success"
                        >27 minutes ago</span
                      >
                    </div>
                  </a>
                  ...
                  >
                    <div class="img-fix width-40 height-40 rounded-circle me3">
                      <img
                        ...
                        src="assets/media/avatars/8.jpg"
                        alt=""
                      />
                    </div>
                    <div class="d-flex flex-column align-items-start">
                      <strong class="text-heading me1"
                        >New message received 👋🏻</strong
                      >
                      <span class="mb1 text-body"
                        >You have 7 unread messages.</span
                      >
                      <span class="badge rounded-pill badge-soft text-bg-info"
                        >48 minutes ago</span
                      >
            ...
            <div class="dropdown">
              ...
              <a
                href="javascript:;"
                class="dropdown-toggle header-dropdown outline-none"
                data-bs-auto-close="outside"
                data-bs-toggle="dropdown"
                aria-expanded="false"
              >
              ...
              <div class="dropdown-menu width-250 p0">
                ...
                <div class="d-flex justify-content-start mb3 p5 pb0">
                  ...
                  <div class="d-flex flex-column text-start">
                    <div class="d-flex flex-row align-items-center">
                      ...
                      <span
                        class="badge badge-soft rounded-pill text-bg-success"
                        >Pro</span
                      >
                    </div>
                ...
                <div class="p5 pt0">
                  <div
                    class="bg-secondary-subtle p3 rounded d-flex justify-content-between"
                  >
                    <span>Balance</span>
                ...
                <div class="p5 pt0 pb0">
                  <ul class="nav flex-column text-start p0">
                    <li class="nav-item">
                      <a
                        class="nav-link text-heading hover-primary ps0"
                        href="pages-account-user-overview.php"
                        >My Profile</a
                      >
                    </li>
                ...
                <div class="p5 pt0">
                  <ul class="nav flex-column text-start p0">
                    <li class="nav-item">
                      <div class="dropdown">
                        <a
                          class="nav-link text-heading hover-primary ps0 pe0 d-flex justify-content-between align-items-center dropdown-toggle outline-none"
                          data-bs-toggle="dropdown"
                          aria-expanded="false"
                          href="#"
                        >
                          Language
                          <span
                            class="badge badge-soft rounded-pill text-bg-primary"
                            >English</span
                          >
                        </a>
                        <ul
                          class="dropdown-menu width-200 flex-column p5 pt4 pb4 text-start"
                        >
                          <li class="nav-item">
                            <a
                              class="nav-link text-heading hover-primary ps0 pe0 d-flex justify-content-between align-items-center"
                              href="#"
                            >
                              English
                              <i
                    ...
                    <li class="nav-item">
                      <div class="dropdown">
                        ...
                        >
                          Theme
                          <span
                            class="badge badge-soft rounded-pill text-bg-light"
                            id="current-theme"
                            >Light</span
                          >
                        </a>
                        ...
                        >
                          <li class="nav-item">
                            <a
                              class="nav-link text-heading hover-primary ps0 pe0 d-flex justify-content-between align-items-center theme-change-light"
                              href="#"
                            >
                              Light
                              <i
                          ...
                          <li class="nav-item">
                            <a
                              class="nav-link text-heading hover-primary ps0 pe0 d-flex justify-content-between align-items-center theme-change-dark"
                              href="#"
                              >Dark</a
                            >
                          </li>
        ...
        <div class="app-content p6 pb2 smp1">
          <div class="container-fluid p0">
                      ...
                      <div class="row mb4 align-items-center">
                        ...
                        <div class="col d-flex flex-row justify-content-end">
                          <div class="d-flex align-items-center me4">
                            <div
                              class="width-10 height-10 bg-primary rounded-circle me1"
                            ></div>
                            <span>Gained</span>
                          </div>
                          <div class="d-flex align-items-center">
                            <div
                              class="width-10 height-10 bg-info rounded-circle me1"
                            ></div>
                            <span>Lost</span>
                          </div>
                        </div>
                ...
                <div class="card shadow-card p5 mb5">
                  <div class="row align-items-center mb4">
                    ...
                    >
                      ...
                      <small
                        ><a
                          href="#"
                          class="text-body text-decoration-none hover-primary"
                          >VIEW ALL</a
                        ></small
                      >
                    </div>
                  ...
                  <div class="row">
                    <div class="col-12">
                      ...
                      >
                        <strong class="text-heading d-block mb4"
                          >Developing an idea for admin dashboard &
                          pages</strong
                        >
                        <div
                        ...
                        >
                          <span
                            class="badge rounded-pill badge-soft text-bg-success p-e"
                            >UI/UX</span
                          >
                          <div class="d-flex align-items-center">
                            <span class="me3">Justin Cas</span>
                            <div
                              class="img-fix rounded-circle width-40 height-40"
                            >
                              <img src="assets/media/avatars/12.jpg" alt="" />
                            </div>
                          </div>
                      ...
                      >
                        <strong class="text-heading d-block mb4"
                          >Find React Framework for car website and mobile
                          app</strong
                        >
                        <div
                          class="d-flex flex-row align-items-center justify-content-between"
                        >
                          <span
                            class="badge rounded-pill badge-soft text-bg-info p-e"
                            >CODE</span
                          >
                          <div class="d-flex align-items-center">
                      ...
                      >
                        <strong class="text-heading d-block mb4"
                          >Redesign header & footer content for client
                          app</strong
                        >
                        <div
                          class="d-flex flex-row align-items-center justify-content-between"
                        >
                          <span
                            class="badge rounded-pill badge-soft text-bg-warning p-e"
                            >APP</span
                          >
                          <div class="d-flex align-items-center">
                      ...
                      <a
                        class="btn btn-info btn-soft d-block mb1"
                        href="#"
                        role="button"
                        >All Tasks</a
                      >
            ...
            <div class="row">
                      ...
                      >
                        <div class="d-flex align-items-center pe6">
                          ...
                          <div class="d-flex flex-column">
                            <strong class="text-heading mb1"
                              >Create new component</strong
                            >
                            <small>2 days remaining</small>
                          </div>
                        </div>
                        <div
                          class="progress width-200 height-5"
                          role="progressbar"
                    ...
                    <div class="col-12">
                      ...
                      >
                        <div class="d-flex align-items-center pe6">
                          ...
                          <div class="d-flex flex-column">
                            <strong class="text-heading mb1"
                              >Improve workflow in Figma</strong
                            >
                    ...
                    <div class="col-12">
                      ...
                      >
                        <div class="d-flex align-items-center pe6">
                          ...
                          <div class="d-flex flex-column">
                            <strong class="text-heading mb1"
                              >Create dark mode for iOS</strong
                            >
                    ...
                    <div class="col-12">
                      ...
                      >
                        <div class="d-flex align-items-center pe6">
                          ...
                          <div class="d-flex flex-column">
                            <strong class="text-heading mb1"
                              >Create wireframe for app</strong
                            >
                            <small>2 days remaining</small>
                          </div>
                        </div>
              ...
              <div class="col-xxl-6 mb5">
                <div
                  class="card shadow-card p6 position-relative overflow-hidden"
                >
                  <div
                    class="position-absolute w-100 height-150 bg-gradient top-0 start-0"
                  ></div>
                  <h6 class="text-center position-relative text-white mb5">
                    Monthly Targets
                  </h6>
                  <!-- Card 1 Start -->
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-5">
                      <div class="bg-light h-100 p6 d-flex align-items-center">
                        <div class="row">
                          <div class="col-12">
                            <strong class="text-heading d-block mb5"
                              >Detail</strong
                            >
                          </div>
                          <div
                            class="col-md-12 col-6 d-flex flex-row align-items-center mb4"
                          >
                            <div
                              class="width-4 height-40 bg-warning rounded me3"
                            ></div>
                            <div class="d-flex flex-column">
                              <span class="text-heading d-block mb0"
                                >Development</span
                              >
                              <small>4 tasks</small>
                            </div>
                          ...
                          >
                            <div
                              class="width-4 height-40 bg-primary rounded me3"
                            ></div>
                            <div class="d-flex flex-column">
                              <span class="text-heading d-block mb0"
                                >UI Design</span
                          ...
                          >
                            <div
                              class="width-4 height-40 bg-success rounded me3"
                            ></div>
                            <div class="d-flex flex-column">
                          ...
                          >
                            <div
                              class="width-4 height-40 bg-info rounded me3"
                            ></div>
                            <div class="d-flex flex-column">
                              <span class="text-heading d-block mb0"
                                >Code Review</span
                          ...
                          <li>
                            ...
                            >
                              ...
                              <i
                                ...
                                data-bs-placement="left"
                                data-bs-custom-class="qd-tooltip"
                                data-bs-title="Only data from the beginning of the year to this time are shown."
                              ></i>
                            </a>
                          </li>
                        </ul>
                        ...
                        <table class="table qd-table mb0">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <span
                                  class="badge badge-soft rounded-pill text-bg-danger"
                                  >Out Stock</span
                                >
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td>
                                <span
                                  class="badge badge-soft rounded-pill text-bg-warning"
                                  >Low Stock</span
                                >
                              </td>
                            </tr>
    ...
    <script
      src="assets/js/pages/dashboards/dashboard-01.js"
