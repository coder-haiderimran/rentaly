...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/apps-projects-add-project.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:36:07 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						<div class="col-md-12 mobile-bottom-fix">
							<h1 class="page-title mb2">Add Persona</h1>
							<nav class="breadcrumb-nav" aria-label="breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="#">Home</a></li>
									<li class="breadcrumb-item"><a href="apps-projects-project-list.php">Project List</a></li>
					...
					<!-- Content Start -->
					<form method="post" action="scripts/add-personas.php" enctype="multipart/form-data">
						<div class="row mb5">
							<!-- Left Column Start -->
							<div class="col-xxl-8">
								<div class="row">
											...
											<div class="row">
												...
												<div class="col-12 mb5">
													...
													<div id="drop-area" class="d-flex bg-light">
														...
														<input type="file" id="fileElem" name="image" accept="image/*" class="d-none">
													</div>
												</div>
												<div class="col-lg-6 mb5">
													...
													<input id="add-form-1" name="name" class="form-control" type="text" required>
												...
												<div class="col-lg-6 mb5">
													<label for="add-form-1" class="form-label">
														<span>Tag Line</span>
														<span class="text-danger">*</span>
														<i data-feather="info" stroke-width="2" width="12" class="text-body" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="qd-tooltip" data-bs-title="Type a Tag line."></i>
													</label>
													<input id="add-form-1" name="heading" class="form-control" type="text" required>
													<div class="invalid-feedback">Please fill out all fields.</div>
												</div>
												<div class="col-12">
													...
													<textarea class="form-control" name="message" id="add-form-5" rows="6"></textarea>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="col-12 text-end mb-4">
								...
								<button type="submit" class="btn btn-primary">Add Persona</button>
							</div>
							<!-- Buttons End -->
							</div>
					</form>
                    ...
                    ?>
												<div class="border-bottom-dashed pb4 pt4 d-flex align-items-center justify-content-between text-decoration-none">
													<div class="d-flex align-items-center justify-content-between">
														<div class="img-fix width-40 height-40 rounded-circle me3">
															<img src="<?php echo('../uploads/personas/' . $DataRows['image']); ?>" alt="">
														</div>
														<div class="d-flex flex-column">
															<strong class="text-heading"><?php echo($DataRows['name']); ?></strong>
															<span class="text-body"><?php echo($DataRows['heading']); ?></span>
														</div>
													</div>
...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/apps-projects-add-project.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:36:09 GMT -->
</html>