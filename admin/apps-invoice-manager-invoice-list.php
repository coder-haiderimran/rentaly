...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/apps-invoice-manager-invoice-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:36:25 GMT -->
<head>
	<meta charset="UTF-8">
			...
			<div class="sidebar-menu custom-scroll pt-4">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							<li class="active"><a href="apps-invoice-manager-invoice-list.php"><span>Invoice List</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						...
						<div class="col-md-6 text-start text-md-end">
							...
							<!-- Add Button Start-->
							<a href="apps-invoice-manager-new-invoice.php" class="btn btn-primary">New Invoice</a>
							<!-- Add Button End-->
						</div>
					</div>
					<!-- Page Top End -->
...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/apps-invoice-manager-invoice-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:36:26 GMT -->
</html>