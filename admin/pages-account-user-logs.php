...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/pages-account-user-logs.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:36:37 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="pages-account-user-logs.php"><span>Logs</span></a></li>
						</ul>
					</li>
					<li class="sub-menu">
						<a href="javascript:;" class="d-flex align-items-center justify-content-between">
						...
						<div class="col-12">
							...
							<div class="card shadow-card overflow-hidden">
								...
								<ul class="horizontal-menu ss-container">
									...
									<li class="active"><a href="pages-account-user-logs.php">Logs</a></li>
								</ul>
							</div>
							<!-- Nav End -->
						</div>
									...
									<table class="table qd-table m0 align-middle">
										...
										<tbody>
											<tr>
												...
												<td>
													<span>/var/www/html/index.php</span>
												</td>
												<td>
