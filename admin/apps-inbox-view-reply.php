...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/apps-inbox-view-reply.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:35:33 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-inbox-view-reply.php"><span>View & Reply</span></a></li>
						</ul>
					</li>
					<li class="sub-menu">
						<a href="javascript:;" class="d-flex align-items-center justify-content-between">
						...
						<div class="col-md-12">
							...
							<nav class="breadcrumb-nav" aria-label="breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="apps-inbox-mailbox.php">Inbox</a></li>
