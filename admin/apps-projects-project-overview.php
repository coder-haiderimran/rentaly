...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/apps-projects-project-overview.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:36:09 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-projects-project-overview.php"><span>Project Overview</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						...
						<div class="col-md-6 text-start text-md-end">
							...
							<a href="apps-projects-add-project.php" class="btn btn-primary">Add New</a>
							<!-- Add Button End-->
						</div>
					</div>
					<!-- Page Top End -->
						...
						<div class="col-xxl-8">
							...
							<div class="card shadow-card mb6">
								<ul class="horizontal-menu ss-container">
									<li class="active"><a href="apps-projects-project-overview.php">Overview</a></li>
									<li><a href="apps-projects-users.php">Users</a></li>
									<li><a href="apps-projects-files.php">Files</a></li>
									<li><a href="apps-projects-activity.php">Activity</a></li>
									<li><a href="apps-projects-settings.php">Settings</a></li>
								</ul>
							</div>
							<!-- Nav End -->
...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/apps-projects-project-overview.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:36:10 GMT -->
</html>