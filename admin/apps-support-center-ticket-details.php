...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/apps-support-center-ticket-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:36:27 GMT -->
<head>
	<meta charset="UTF-8">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							...
							<li class="active"><a href="apps-support-center-ticket-details.php"><span>Ticket Details</span></a></li>
						</ul>
					</li>
					<li class="sub-menu">
						<a href="javascript:;" class="d-flex align-items-center justify-content-between">
						...
						<div class="col-md-6 mobile-bottom-fix">
							...
							<nav class="breadcrumb-nav" aria-label="breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="apps-support-center-overview.php">Support Center</a></li>
...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/apps-support-center-ticket-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:36:28 GMT -->
</html>