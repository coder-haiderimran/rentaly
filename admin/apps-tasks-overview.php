...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/apps-tasks-overview.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:36:11 GMT -->
<head>
	<meta charset="UTF-8">
			...
			<div class="sidebar-menu custom-scroll pt-4">
				...
				<ul class="menu-group m-0 px-4 mb-4">	
					...
					<li class="sub-menu active">
						...
						<ul class="sub-menu-group">
							<li class="active"><a href="apps-tasks-overview.php"><span>Overview</span></a></li>
				...
				<div class="container p0">
					...
					<div class="row mb6 align-items-center">
						...
						<div class="col-md-6 text-start text-md-end">
							...
							<!-- Add Button Start-->
							<a href="apps-tasks-add-task.php" class="btn btn-primary">Add Task</a>
							<!-- Add Button End-->
						</div>
					</div>
					<!-- Page Top End -->
									...
									<div class="col-xxl-8 ps0">
										<div class="p6">
											...
											<div class="d-flex align-items-center justify-content-between">
												...
												<div class="d-flex align-items-center justify-content-start">
													<a href="apps-tasks-add-task.php" class="btn btn-primary me3">Add New Task</a>
													<a href="apps-tasks-task-detail.php" class="btn btn-primary btn-soft">Project Details</a>
												</div>
											</div>
										</div>
									</div>
...
<!-- Mirrored from qoduby.tempload.com/html/demo1/dist/apps-tasks-overview.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Mar 2024 06:36:14 GMT -->
</html>